...
public class DetailDoneOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_done_order);
        ...
        if (DoneOrder.jobOrders.get(index) != null) {
            jobOrder = DoneOrder.jobOrders.get(index);
        }
        if (jobOrder != null) {
