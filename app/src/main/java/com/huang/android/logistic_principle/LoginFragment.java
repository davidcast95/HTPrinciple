...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(com.huang.android.logistic_principle.R.layout.fragment_login, container, false);

        usernameEditText = (EditText)v.findViewById(com.huang.android.logistic_principle.R.id.login_username);
        passwordEditText = (EditText)v.findViewById(com.huang.android.logistic_principle.R.id.login_password);
        loginButton = (Button)v.findViewById(com.huang.android.logistic_principle.R.id.login_button);
            ...
            public void onResponse(Call<LoginPrinciple> call, Response<LoginPrinciple> response) {
                ...
                if(Utility.utility.catchResponse(getActivity().getApplicationContext(), response)){
                    ...
                    if(profileFragment != null){
                        fragmentManager.beginTransaction().replace(com.huang.android.logistic_principle.R.id.contentLayout,
